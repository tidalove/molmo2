...
#SBATCH --job-name=cfc_debug_lora_llm_connector_vit
...
#SBATCH --mem=400G
#SBATCH --output=/data/vision/beery/scratch/kai/molmo2/logs/cfc_debug_lora_llm_connector_vit_%j.log
...
NAME=cfc_all_real
DEBUG_NAME=cfc_debug_lora_llm_connector_vit
CKPT=Molmo2-8B
